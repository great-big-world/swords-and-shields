...
public class SwordsAndShields implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        DefaultItemComponentEvents.MODIFY.register(modifyContext -> {
            ...
            modifyContext.modify(item -> item == Items.ORANGE_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.ORANGE)));
            modifyContext.modify(item -> item == Items.YELLOW_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.YELLOW)));
            modifyContext.modify(item -> item == Items.LIME_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.LIME)));
            modifyContext.modify(item -> item == Items.GREEN_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.GREEN)));
            modifyContext.modify(item -> item == Items.CYAN_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.CYAN)));
            modifyContext.modify(item -> item == Items.BLUE_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.BLUE)));
            modifyContext.modify(item -> item == Items.LIGHT_BLUE_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.LIGHT_BLUE)));
            modifyContext.modify(item -> item == Items.PINK_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.PINK)));
            modifyContext.modify(item -> item == Items.MAGENTA_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.MAGENTA)));
            modifyContext.modify(item -> item == Items.PURPLE_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.PURPLE)));
            modifyContext.modify(item -> item == Items.BLACK_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.BLACK)));
            modifyContext.modify(item -> item == Items.GRAY_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.GRAY)));
            modifyContext.modify(item -> item == Items.LIGHT_GRAY_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.LIGHT_GRAY)));
            modifyContext.modify(item -> item == Items.WHITE_DYE, (builder, item) -> builder.set(DataComponents.PROVIDES_TRIM_MATERIAL, new ProvidesTrimMaterial(SwordsAndShieldsTrimMaterials.WHITE)));
        });
