...
public final class SwordsAndShieldsBlockEntities {
    public static final BlockEntityType<EnchantedStoneBlockEntity> ENCHANTED_STONE = BlockEntityType.Builder.create(EnchantedStoneBlockEntity::new, SwordsAndShieldBlocks.ENCHANTED_STONE).build();
