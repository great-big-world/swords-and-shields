...
public interface EnchantmentPlayer {
    boolean gbw$addEnchantment(RegistryKey<Enchantment> enchantment);

    Set<RegistryKey<Enchantment>> gbw$getEnchantments();

    static void addEnchantedStone(StructureWorldAccess world, BlockPos pos, RegistryKey<Enchantment> enchantment, BlockBox boundingBox) {
